...
const Presentation =()=>{
	...
	<section className='home-presentation-container'>		
		<div className='home-presentation'>
			<h2 className='home-presentation-title'>Loud and Clear GmbH:<span>High-end sound fields</span></h2>					
			<p className='home-presentation-paragraph'>Loud and Clear is a creative and production studio specializing in spatial and sound design with a strong expertise in dance music, off location events and contemporary lifestyle.</p>
		</div>
